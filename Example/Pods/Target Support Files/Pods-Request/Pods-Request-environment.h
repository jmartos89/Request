...
// Request
#define COCOAPODS_POD_AVAILABLE_Request
#define COCOAPODS_VERSION_MAJOR_Request 0
#define COCOAPODS_VERSION_MINOR_Request 1
#define COCOAPODS_VERSION_PATCH_Request 0
